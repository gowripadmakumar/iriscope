...
IRISCOPE solves this completely unnecessary problem by detecting and counting the approximate visible radial structures in your iris.
...
## Team Contributions
- Gowri Padmakumar: Concept development, UI/UX design, Python/Flask backend, computer-vision pipeline, iris detection and radial structure counting, frontend development, testing, debugging, documentation, and deployment.]
